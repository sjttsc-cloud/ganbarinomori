          ...
          <div className="relative w-full max-w-sm h-[26rem] flex flex-col items-center justify-center overflow-hidden">
            ...
            <div className="w-72 h-72 rounded-full bg-white bg-opacity-95 backdrop-blur-md border-8 border-dashed border-pastel-yellow shadow-2xl flex items-center justify-center relative z-10 p-6 ring-12 ring-white ring-opacity-40 transform hover:scale-105 transition-all text-text-main">
              ...
              <div key={countdown} className="relative select-none animate-pop-countdown flex flex-col items-center justify-center text-center w-full">
                {countdown === 3 && (
                  <span className="text-[140px] font-black text-blue-600 drop-shadow-[0_6px_12px_rgba(30,58,138,0.4)] leading-none font-sans select-none">3</span>
                )}
                {countdown === 2 && (
                  <span className="text-[140px] font-black text-emerald-500 drop-shadow-[0_6px_12px_rgba(16,185,129,0.4)] leading-none font-sans select-none">2</span>
                )}
                {countdown === 1 && (
                  <span className="text-[140px] font-black text-amber-500 drop-shadow-[0_6px_12px_rgba(245,158,11,0.4)] leading-none font-sans select-none">1</span>
                )}
                {countdown === 0 && (
                  <span className="text-5xl md:text-6xl font-black bg-gradient-to-r from-orange-500 via-red-500 to-yellow-400 bg-clip-text text-transparent drop-shadow-[0_3px_6px_rgba(239,68,68,0.3)] leading-none py-1 font-sans select-none">
                    よーい どん！
                  </span>
                )}
              </div>
